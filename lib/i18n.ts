...
const UI_STRINGS: Record<string, { ko: string; en?: string }> = {
  ...
  "member.role.배우":       { ko: "배우", en: "Actor" },
  "member.role.모델":       { ko: "모델", en: "Model" },
  "member.role.인플루언서": { ko: "인플루언서", en: "Influencer" },
  "member.role.크리에이터": { ko: "크리에이터", en: "Creator" },
  "member.role.가수":       { ko: "가수", en: "Singer" },
  "member.role.댄서":       { ko: "댄서", en: "Dancer" },
  "member.role.연출":       { ko: "연출", en: "Director" },
  "member.role.감독":       { ko: "감독", en: "Director" },
  "member.role.각본":       { ko: "각본", en: "Writer" },
  "member.role.작가":       { ko: "작가", en: "Writer" },
  "member.role.촬영":       { ko: "촬영", en: "Cinematographer" },
  "member.role.조명":       { ko: "조명", en: "Lighting" },
  "member.role.편집":       { ko: "편집", en: "Editor" },
  "member.role.음악":       { ko: "음악", en: "Music" },
  "member.role.사운드":     { ko: "사운드", en: "Sound" },
  "member.role.스타일링":   { ko: "스타일링", en: "Styling" },
  "member.role.의상":       { ko: "의상", en: "Costume" },
  "member.role.분장":       { ko: "분장", en: "Makeup" },
  "member.role.미술":       { ko: "미술", en: "Art" },
  "member.role.기획":       { ko: "기획", en: "Producer" },
  "member.role.제작":       { ko: "제작", en: "Production" },
  "member.role.PD":         { ko: "PD", en: "PD" },
  "member.role.대표":       { ko: "대표", en: "CEO" },
  "member.role.대표이사":   { ko: "대표이사", en: "CEO" },
  "member.role.운영":       { ko: "운영", en: "Operations" },
  "member.role.스태프":     { ko: "스태프", en: "Staff" },
